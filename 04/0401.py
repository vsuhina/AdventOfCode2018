...
class GuardStats:
    ...
    def __str__(self):
        return "GuardId #{0}: Sleep: {1}, Awake: {2}, Days: {3}, Min: {4}".format(self.guardId, self.sleep, self.awake, self.dayCount, self.whenMaxSleep() )
...
if __name__ == "__main__":
    ...
    g = max(guards,key = lambda x:x.sleep)
    print('Sleeper:')
    print(g)
    print(g.getRes())
